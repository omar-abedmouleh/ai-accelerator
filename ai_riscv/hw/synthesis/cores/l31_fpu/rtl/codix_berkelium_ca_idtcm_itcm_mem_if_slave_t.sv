 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_idtcm_itcm_mem_if_slave_t' CodAL interface.
 *  \note    
...
module codix_berkelium_ca_idtcm_itcm_mem_if_slave_t #(
    ...
    output logic [(ADDR_BITS)-1:0] idtcm_itcm_mem_sram_if_slave_A
);
    ...
    assign idtcm_itcm_mem_sram_if_slave_CS = (if_slave_RE_wire | (if_slave_WE_wire | if_slave_raw_reg_Q));
    assign idtcm_itcm_mem_sram_if_slave_RW = if_slave_WE_wire;
    assign idtcm_itcm_mem_sram_if_slave_A = ((if_slave_RE_wire == 1'b1) && (if_slave_raw_reg_Q == 1'b0)) ? if_slave_HADDR[((ADDR_BITS + 32'h00000002) - 32'h00000001):32'h00000002] : if_slave_addr_reg_Q;
    assign idtcm_itcm_mem_sram_if_slave_WSTRB = if_slave_wstrb_wire;
    assign idtcm_itcm_mem_sram_if_slave_WDATA = if_slave_HWDATA;
    assign if_slave_HREADYOUT = if_slave_HREADYOUT_reg_Q;
    assign if_slave_HRESP = if_slave_HRESP_reg_Q;
    assign if_slave_HRDATA = idtcm_itcm_mem_sram_if_slave_RDATA;
endmodule: codix_berkelium_ca_idtcm_itcm_mem_if_slave_t
