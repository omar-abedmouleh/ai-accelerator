 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_idtcm_itcm_mem_sram_storage_t' Codasip memory data storage.
 *           size: 4096
...
module codix_berkelium_ca_idtcm_itcm_mem_sram_storage_t #(
...
endmodule: codix_berkelium_ca_idtcm_itcm_mem_sram_storage_t
