 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_core_execute_stage_lsu_pma_ldst_t' CodAL module.
 *  \note    
...
module codix_berkelium_ca_core_execute_stage_lsu_pma_ldst_t #(
    ...
    // instance of 's_size_i' CodAL signal/wire: (single driver)
    assign s_size_i = s_size_i_D;
    ...
    // instance of 's_misaligned_o' CodAL signal/wire: (parent port driver(s))
    assign s_misaligned_o_Q = s_misaligned_o;
    // functional unit instance:
    codix_berkelium_ca_core_execute_stage_lsu_pma_ldst_check_t #(
        ...
        .s_misaligned_o_D(s_misaligned_o)
    );

endmodule: codix_berkelium_ca_core_execute_stage_lsu_pma_ldst_t
