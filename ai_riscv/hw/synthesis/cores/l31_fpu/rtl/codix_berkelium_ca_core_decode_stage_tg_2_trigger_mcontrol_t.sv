 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_core_decode_stage_tg_2_trigger_mcontrol_t' functional unit.
 *  \note    
...
module codix_berkelium_ca_core_decode_stage_tg_2_trigger_mcontrol_t(
    ...
    // data-path code:
    assign s_trigger_tdata1_B0 = r_csr_tdata1_r2_Q;
    assign s_trigger_match_data_B0 = r_csr_tdata2_r2_Q;
    ...
    assign r_csr_tdata1_r2_RA = 3'h2;
    assign r_csr_tdata1_r2_RE = 1'b1;
    assign r_csr_tdata2_r2_RA = 3'h2;
    assign r_csr_tdata2_r2_RE = 1'b1;
    assign s_trigger_action_o_D = s_trigger_tdata1_B0[12];
    assign s_trigger_fire_o_D = ((prv_en_B0 && access_type_en_B0) && match_B0);
endmodule: codix_berkelium_ca_core_decode_stage_tg_2_trigger_mcontrol_t
