 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_core_r_csr_tdata2_t' CodAL register file.
 *           size: 8
...
module codix_berkelium_ca_core_r_csr_tdata2_t(
    input  logic CLK,
    input  logic RST,
    input  logic r_RE,
...
endmodule: codix_berkelium_ca_core_r_csr_tdata2_t
