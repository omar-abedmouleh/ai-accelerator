 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_idtcm_dtcm_mem_t' Codasip memory.
*
...
module codix_berkelium_ca_idtcm_dtcm_mem_t #(
    ...
    output logic [($clog2(SIZE / 32'd4))-1:0] idtcm_dtcm_mem_sram_if_slave_A,
    ...
    codix_berkelium_ca_idtcm_dtcm_mem_if_slave_t #(
        .SIZE(SIZE),
...
endmodule: codix_berkelium_ca_idtcm_dtcm_mem_t
