 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_cache_l1_dcache_dirty_sram_storage_t' Codasip memory data storage.
 *           size: 256
...
module codix_berkelium_ca_cache_l1_dcache_dirty_sram_storage_t #(
...
endmodule: codix_berkelium_ca_cache_l1_dcache_dirty_sram_storage_t
