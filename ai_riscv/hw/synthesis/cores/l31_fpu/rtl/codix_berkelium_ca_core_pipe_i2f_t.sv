 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_core_pipe_i2f_t' pipeline controller.
 *  \note    
...
module codix_berkelium_ca_core_pipe_i2f_t(
...
endmodule: codix_berkelium_ca_core_pipe_i2f_t
