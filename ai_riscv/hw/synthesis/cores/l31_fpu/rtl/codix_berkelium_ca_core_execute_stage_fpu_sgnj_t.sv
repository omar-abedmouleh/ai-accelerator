 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_core_execute_stage_fpu_sgnj_t' CodAL module.
 *  \note    
...
module codix_berkelium_ca_core_execute_stage_fpu_sgnj_t(
    ...
    codix_berkelium_ca_core_execute_stage_fpu_sgnj_compute_sgnj_t compute_sgnj (
        .s_op_i_Q(s_op_i),
...
endmodule: codix_berkelium_ca_core_execute_stage_fpu_sgnj_t
