 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_core_decode_stage_tg_6_t' CodAL module.
 *  \note    
...
module codix_berkelium_ca_core_decode_stage_tg_6_t(
    ...
    codix_berkelium_ca_core_decode_stage_tg_6_trigger_mcontrol_t trigger_mcontrol (
...
endmodule: codix_berkelium_ca_core_decode_stage_tg_6_t
