 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_core_execute_stage_lsu_pmp_ldst_check_t' functional unit.
 *  \note    
...
module codix_berkelium_ca_core_execute_stage_lsu_pmp_ldst_check_t(
    ...
    assign pmp0_hit_napot_B0 = (pmp0cfg_B0[4] && ((r_csr_pmpaddr0_Q | r_pmp0_napot_mask_Q) == (s_addr_i_Q | r_pmp0_napot_mask_Q)));
    assign pmp1_hit_napot_B0 = (pmp1cfg_B0[4] && ((r_csr_pmpaddr1_Q | r_pmp1_napot_mask_Q) == (s_addr_i_Q | r_pmp1_napot_mask_Q)));
    assign pmp2_hit_napot_B0 = (pmp2cfg_B0[4] && ((r_csr_pmpaddr2_Q | r_pmp2_napot_mask_Q) == (s_addr_i_Q | r_pmp2_napot_mask_Q)));
    assign pmp3_hit_napot_B0 = (pmp3cfg_B0[4] && ((r_csr_pmpaddr3_Q | r_pmp3_napot_mask_Q) == (s_addr_i_Q | r_pmp3_napot_mask_Q)));
    assign pmp4_hit_napot_B0 = (pmp4cfg_B0[4] && ((r_csr_pmpaddr4_Q | r_pmp4_napot_mask_Q) == (s_addr_i_Q | r_pmp4_napot_mask_Q)));
    assign pmp5_hit_napot_B0 = (pmp5cfg_B0[4] && ((r_csr_pmpaddr5_Q | r_pmp5_napot_mask_Q) == (s_addr_i_Q | r_pmp5_napot_mask_Q)));
    assign pmp6_hit_napot_B0 = (pmp6cfg_B0[4] && ((r_csr_pmpaddr6_Q | r_pmp6_napot_mask_Q) == (s_addr_i_Q | r_pmp6_napot_mask_Q)));
    assign pmp7_hit_napot_B0 = (pmp7cfg_B0[4] && ((r_csr_pmpaddr7_Q | r_pmp7_napot_mask_Q) == (s_addr_i_Q | r_pmp7_napot_mask_Q)));
    assign pmp8_hit_napot_B0 = (pmp8cfg_B0[4] && ((r_csr_pmpaddr8_Q | r_pmp8_napot_mask_Q) == (s_addr_i_Q | r_pmp8_napot_mask_Q)));
    assign pmp9_hit_napot_B0 = (pmp9cfg_B0[4] && ((r_csr_pmpaddr9_Q | r_pmp9_napot_mask_Q) == (s_addr_i_Q | r_pmp9_napot_mask_Q)));
    assign pmp10_hit_napot_B0 = (pmp10cfg_B0[4] && ((r_csr_pmpaddr10_Q | r_pmp10_napot_mask_Q) == (s_addr_i_Q | r_pmp10_napot_mask_Q)));
    assign pmp11_hit_napot_B0 = (pmp11cfg_B0[4] && ((r_csr_pmpaddr11_Q | r_pmp11_napot_mask_Q) == (s_addr_i_Q | r_pmp11_napot_mask_Q)));
    assign pmp12_hit_napot_B0 = (pmp12cfg_B0[4] && ((r_csr_pmpaddr12_Q | r_pmp12_napot_mask_Q) == (s_addr_i_Q | r_pmp12_napot_mask_Q)));
    assign pmp13_hit_napot_B0 = (pmp13cfg_B0[4] && ((r_csr_pmpaddr13_Q | r_pmp13_napot_mask_Q) == (s_addr_i_Q | r_pmp13_napot_mask_Q)));
    assign pmp14_hit_napot_B0 = (pmp14cfg_B0[4] && ((r_csr_pmpaddr14_Q | r_pmp14_napot_mask_Q) == (s_addr_i_Q | r_pmp14_napot_mask_Q)));
    assign pmp15_hit_napot_B0 = (pmp15cfg_B0[4] && ((r_csr_pmpaddr15_Q | r_pmp15_napot_mask_Q) == (s_addr_i_Q | r_pmp15_napot_mask_Q)));
    ...
    assign pmp0_pass_B0 = ((pmp0cfg_B0[0] & (~s_write_i_Q)) | (pmp0cfg_B0[1] & s_write_i_Q));
    assign pmp1_pass_B0 = ((pmp1cfg_B0[0] & (~s_write_i_Q)) | (pmp1cfg_B0[1] & s_write_i_Q));
    assign pmp2_pass_B0 = ((pmp2cfg_B0[0] & (~s_write_i_Q)) | (pmp2cfg_B0[1] & s_write_i_Q));
    assign pmp3_pass_B0 = ((pmp3cfg_B0[0] & (~s_write_i_Q)) | (pmp3cfg_B0[1] & s_write_i_Q));
    assign pmp4_pass_B0 = ((pmp4cfg_B0[0] & (~s_write_i_Q)) | (pmp4cfg_B0[1] & s_write_i_Q));
    assign pmp5_pass_B0 = ((pmp5cfg_B0[0] & (~s_write_i_Q)) | (pmp5cfg_B0[1] & s_write_i_Q));
    assign pmp6_pass_B0 = ((pmp6cfg_B0[0] & (~s_write_i_Q)) | (pmp6cfg_B0[1] & s_write_i_Q));
    assign pmp7_pass_B0 = ((pmp7cfg_B0[0] & (~s_write_i_Q)) | (pmp7cfg_B0[1] & s_write_i_Q));
    assign pmp8_pass_B0 = ((pmp8cfg_B0[0] & (~s_write_i_Q)) | (pmp8cfg_B0[1] & s_write_i_Q));
    assign pmp9_pass_B0 = ((pmp9cfg_B0[0] & (~s_write_i_Q)) | (pmp9cfg_B0[1] & s_write_i_Q));
    assign pmp10_pass_B0 = ((pmp10cfg_B0[0] & (~s_write_i_Q)) | (pmp10cfg_B0[1] & s_write_i_Q));
    assign pmp11_pass_B0 = ((pmp11cfg_B0[0] & (~s_write_i_Q)) | (pmp11cfg_B0[1] & s_write_i_Q));
    assign pmp12_pass_B0 = ((pmp12cfg_B0[0] & (~s_write_i_Q)) | (pmp12cfg_B0[1] & s_write_i_Q));
    assign pmp13_pass_B0 = ((pmp13cfg_B0[0] & (~s_write_i_Q)) | (pmp13cfg_B0[1] & s_write_i_Q));
    assign pmp14_pass_B0 = ((pmp14cfg_B0[0] & (~s_write_i_Q)) | (pmp14cfg_B0[1] & s_write_i_Q));
    assign pmp15_pass_B0 = ((pmp15cfg_B0[0] & (~s_write_i_Q)) | (pmp15cfg_B0[1] & s_write_i_Q));
    ...
    assign s_fault_o_D = ((~pmp_access_granted_B0) & s_valid_i_Q);
endmodule: codix_berkelium_ca_core_execute_stage_lsu_pmp_ldst_check_t
