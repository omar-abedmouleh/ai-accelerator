 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_core_execute_stage_b_unit_t' CodAL module.
 *  \note    
...
module codix_berkelium_ca_core_execute_stage_b_unit_t(
    ...
    codix_berkelium_ca_core_execute_stage_b_unit_compute_t compute (
        .ACT(compute_ACT),
        .s_op_i_Q(s_op_i),
...
endmodule: codix_berkelium_ca_core_execute_stage_b_unit_t
