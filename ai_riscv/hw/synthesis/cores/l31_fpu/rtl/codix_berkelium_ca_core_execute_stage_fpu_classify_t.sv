 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_core_execute_stage_fpu_classify_t' CodAL module.
 *  \note    
...
module codix_berkelium_ca_core_execute_stage_fpu_classify_t(
    ...
    codix_berkelium_ca_core_execute_stage_fpu_classify_compute_classify_t compute_classify (
        .s_done_o_Q(s_done_o),
        .s_properties_i_Q(s_properties_i[4:1]),
        .s_result_o_Q(s_result_o),
        .s_ROB_ptr_i_Q(s_ROB_ptr_i),
        .s_srcA_i_Q(s_srcA_i[31:22]),
...
endmodule: codix_berkelium_ca_core_execute_stage_fpu_classify_t
