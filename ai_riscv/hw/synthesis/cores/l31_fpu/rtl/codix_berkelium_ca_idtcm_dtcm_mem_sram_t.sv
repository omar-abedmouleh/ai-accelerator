 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_idtcm_dtcm_mem_sram_t' Codasip SRAM logic.
 *           size: 4096
...
module codix_berkelium_ca_idtcm_dtcm_mem_sram_t #(
    ...
    codix_berkelium_ca_idtcm_dtcm_mem_sram_storage_t #(
        .SIZE(SIZE),
        .ADDR_BITS(ADDR_BITS)
    ) storage (
        .CLK(CLK),
...
endmodule: codix_berkelium_ca_idtcm_dtcm_mem_sram_t
