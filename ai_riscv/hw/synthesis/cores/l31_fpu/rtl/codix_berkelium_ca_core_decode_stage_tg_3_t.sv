 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_core_decode_stage_tg_3_t' CodAL module.
 *  \note    
...
module codix_berkelium_ca_core_decode_stage_tg_3_t(
    ...
    codix_berkelium_ca_core_decode_stage_tg_3_trigger_mcontrol_t trigger_mcontrol (
...
endmodule: codix_berkelium_ca_core_decode_stage_tg_3_t
