 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_core_fetch_stage_ifu_pmp_fetch_t' CodAL module.
 *  \note    
...
module codix_berkelium_ca_core_fetch_stage_ifu_pmp_fetch_t(
    ...
    codix_berkelium_ca_core_fetch_stage_ifu_pmp_fetch_check_t check (
...
endmodule: codix_berkelium_ca_core_fetch_stage_ifu_pmp_fetch_t
