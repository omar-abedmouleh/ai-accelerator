 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_core_execute_stage_alu_t' CodAL module.
 *  \note    
...
module codix_berkelium_ca_core_execute_stage_alu_t(
    ...
    output logic s_take_branch_o_Q
);
    ...
    // instance of 's_take_branch_o' CodAL signal/wire: (parent port driver(s))
    assign s_take_branch_o_Q = s_take_branch_o;
    // functional unit instance:
    codix_berkelium_ca_core_execute_stage_alu_compute_t compute (
        .ACT(compute_ACT),
        .s_op_i_Q(s_op_i),
        .s_s1_data_i_Q(s_s1_data_i),
        .s_s2_data_i_Q(s_s2_data_i),
        .s_rd_data_o_D(s_rd_data_o),
        .s_take_branch_o_D(s_take_branch_o)
    );

endmodule: codix_berkelium_ca_core_execute_stage_alu_t
