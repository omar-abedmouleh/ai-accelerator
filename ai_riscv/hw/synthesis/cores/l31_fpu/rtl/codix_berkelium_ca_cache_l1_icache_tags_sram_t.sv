 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_cache_l1_icache_tags_sram_t' Codasip SRAM logic.
 *           size: 256
...
module codix_berkelium_ca_cache_l1_icache_tags_sram_t #(
    ...
    generate
        for ( ii = 32'sd0; ii < BANK_COUNT; ii = ii + 32'sd1 ) begin : BANK
            ...
            codix_berkelium_ca_cache_l1_icache_tags_sram_storage_t #(
                .SIZE(SIZE),
                .ADDR_BITS(ADDR_BITS),
...
endmodule: codix_berkelium_ca_cache_l1_icache_tags_sram_t
