 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_core_execute_stage_lsu_pma_ldst_check_t' functional unit.
 *  \note    
...
module codix_berkelium_ca_core_execute_stage_lsu_pma_ldst_check_t #(
    ...
    output logic s_misaligned_o_D
);
    // type, wire and constant declarations:
    // signal/wire
    logic [1:0] codasip_tmp_var_0;
    // signal/wire
    logic s_misaligned_o_D_ACT_wire;

    // data-path code:
    assign codasip_tmp_var_0 = s_size_i_Q;
    always_comb begin
        unique case ( codasip_tmp_var_0 )
            2'h0: s_misaligned_o_D_ACT_wire = 1'b0;
            2'h1: s_misaligned_o_D_ACT_wire = s_addr_i_Q[0];
            2'h2: s_misaligned_o_D_ACT_wire = (s_addr_i_Q[1:0] != 2'h0);
            2'h3: s_misaligned_o_D_ACT_wire = (s_addr_i_Q[2:0] != 3'h0);
            ...
            default: s_misaligned_o_D_ACT_wire = 1'bx;
            // pragma translate_on
        endcase
    end
    ...
    assign s_misaligned_o_D = s_misaligned_o_D_ACT_wire;
endmodule: codix_berkelium_ca_core_execute_stage_lsu_pma_ldst_check_t
