 ...
 *  \version 9.4.1
 *  \brief   Contains module definition of the 'codix_berkelium_ca_core_fetch_stage_ifu_pma_t' CodAL module.
 *  \note    
...
module codix_berkelium_ca_core_fetch_stage_ifu_pma_t #(
    ...
    output logic fetch_s_cacheable_o_Q,
    output logic fetch_s_fault_o_Q,
    output logic fetch_s_idempotent_o_Q
);
    // child instances inside CodAL module:
    // CodAL module instance:
    codix_berkelium_ca_core_fetch_stage_ifu_pma_fetch_t #(
        ...
        .s_cacheable_o_Q(fetch_s_cacheable_o_Q),
        .s_fault_o_Q(fetch_s_fault_o_Q),
        .s_idempotent_o_Q(fetch_s_idempotent_o_Q)
    );

endmodule: codix_berkelium_ca_core_fetch_stage_ifu_pma_t
